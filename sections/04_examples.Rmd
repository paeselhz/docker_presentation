...
--
  ...
  ## O Projeto Rocker é mantido Carl Boettiger(UC Berkeley) e Dirk Eddelbuettel(Univ. of Illinois) e pela comunidade `r icon::fa_r_project()`.
  ### O objetivo do projeto é fornecer no DockerHub `r icon::fa_docker()` imagens dos principais serviços que podem ser hospeados com um ambiente R.
...
--
  ...
  ## O código fonte pode ser encontrado no [GitHub `r icon::ii_social_github()`](https://github.com/trestletech/plumber)
