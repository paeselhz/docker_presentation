...
--
  ...
  ## O Docker é uma interface que manipula diferentes sistemas operacionais (chamados de Containers) em uma máquina. Ele encapsula diferentes versões de ambiente, .text-hl2[Sistema Operacional, Programas, Pacotes e Scripts] desenvolvidos pelo usuário, em imagens.
